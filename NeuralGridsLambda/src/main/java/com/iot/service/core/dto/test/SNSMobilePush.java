...
package com.iot.service.core.dto.test;
...
public class SNSMobilePush {
	...
	public static void main(String[] args){
		...
		try {
			...
			push.pushFCMNotification(userDeviceIdKey,"Hardcoded","HTitle");
		} catch (Exception e){
			e.printStackTrace();
		}
	}	

	public static void pushFCMNotification(String userDeviceIdKey,String message,String title) throws Exception{
		String 	API_URL_FCM	=	"https://fcm.googleapis.com/fcm/send";
		String AUTH_KEY_FCM	=	"AAAAl1QlqSw:APA91bG_iVbjsCQkN0b5jAQQDSTZAJiQ9z6X12CgeKKDYO4BGM_Ofx3aP7mxRbDFMRjfekUyQFbKbrdhZ_XZmWLAZZd4mh6inCOLwC43v_d8J4jwUMpttjhRxVqL0uH6sKwesBsa0bPfBEl9Utu3oru8IQVgY-nsXw";
